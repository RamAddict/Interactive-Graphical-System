...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 182, 110))
        ...
        self.angle_label.setGeometry(QRect(130, 120, 41, 16))
        self.rotate_label = QLabel(self.transformPage)
        self.rotate_label.setObjectName(u"rotate_label")
        self.rotate_label.setGeometry(QRect(0, 100, 41, 16))
        ...
        self.line_3.setGeometry(QRect(-10, 230, 281, 16))
        ...
        self.scale_label.setGeometry(QRect(0, 150, 41, 16))
        ...
        self.trs_box_confirm.setGeometry(QRect(40, 240, 164, 32))
        ...
        self.line.setGeometry(QRect(0, 90, 281, 16))
        self.line.setFrameShape(QFrame.HLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.line_2 = QFrame(self.transformPage)
        self.line_2.setObjectName(u"line_2")
        self.line_2.setGeometry(QRect(10, 140, 281, 16))
        self.line_2.setFrameShape(QFrame.HLine)
        self.line_2.setFrameShadow(QFrame.Sunken)
        self.rotate_axis_select = QComboBox(self.transformPage)
        self.rotate_axis_select.addItem("")
        self.rotate_axis_select.addItem("")
        self.rotate_axis_select.addItem("")
        self.rotate_axis_select.setObjectName(u"rotate_axis_select")
        self.rotate_axis_select.setGeometry(QRect(70, 120, 51, 26))
        self.scale_x_label = QLabel(self.transformPage)
        self.scale_x_label.setObjectName(u"scale_x_label")
        self.scale_x_label.setGeometry(QRect(55, 160, 16, 16))
        self.scale_y_label = QLabel(self.transformPage)
        self.scale_y_label.setObjectName(u"scale_y_label")
        self.scale_y_label.setGeometry(QRect(55, 180, 16, 16))
        self.scale_z_label = QLabel(self.transformPage)
        self.scale_z_label.setObjectName(u"scale_z_label")
        self.scale_z_label.setGeometry(QRect(55, 200, 16, 16))
        self.scale_x = QLineEdit(self.transformPage)
        self.scale_x.setObjectName(u"scale_x")
        self.scale_x.setGeometry(QRect(75, 160, 113, 21))
        self.scale_y = QLineEdit(self.transformPage)
        self.scale_y.setObjectName(u"scale_y")
        self.scale_y.setGeometry(QRect(75, 180, 113, 21))
        self.scale_z = QLineEdit(self.transformPage)
        self.scale_z.setObjectName(u"scale_z")
        self.scale_z.setGeometry(QRect(75, 200, 113, 21))
        self.scale_z.setReadOnly(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rotate_angle_input.setText(QCoreApplication.translate("MainWindow", u"0", None))
        ...
        self.translate_x.setText(QCoreApplication.translate("MainWindow", u"0", None))
        self.scale_label.setText(QCoreApplication.translate("MainWindow", u"Scale", None))
        self.translate_z.setText(QCoreApplication.translate("MainWindow", u"0", None))
        self.translate_y.setText(QCoreApplication.translate("MainWindow", u"0", None))
        self.rotate_axis_select.setItemText(0, QCoreApplication.translate("MainWindow", u"X", None))
        self.rotate_axis_select.setItemText(1, QCoreApplication.translate("MainWindow", u"Y", None))
        self.rotate_axis_select.setItemText(2, QCoreApplication.translate("MainWindow", u"Z", None))

        self.scale_x_label.setText(QCoreApplication.translate("MainWindow", u"X:", None))
        self.scale_y_label.setText(QCoreApplication.translate("MainWindow", u"Y:", None))
        self.scale_z_label.setText(QCoreApplication.translate("MainWindow", u"Z:", None))
        self.scale_x.setText(QCoreApplication.translate("MainWindow", u"1", None))
        self.scale_y.setText(QCoreApplication.translate("MainWindow", u"1", None))
        self.scale_z.setText(QCoreApplication.translate("MainWindow", u"1", None))
    # retranslateUi
