...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.main_vie_port = QGraphicsView(self.centralwidget)
        self.main_vie_port.setObjectName(u"main_vie_port")
        self.main_vie_port.setGeometry(QRect(-10, -10, 591, 421))
        ...
        self.textBrowser_2.setGeometry(QRect(0, 430, 591, 171))
